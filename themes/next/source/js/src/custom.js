...
function createCopyBtns() {
  ...
  if ($codeArea.length > 0) {
    ...
    var copyStr = '<span id="imgCopy" title="复制代码"><i class="fa fa-paste"></i></span>';
    var successStr = '<span id="imgSuccess" style="display: none;"><i class="fa fa-check-circle" aria-hidden="true"></i></span>';
    $(".post-body").before('<div id="copyBtn">' + successStr + copyStr);
...
function() {
  ...
  if ($copyBtn.lenght != 0) {
    ...
    $copyBtn.css("right", $copyBtn.width() - 7);
  }
},
function() {
  //-------鼠标离开代码块
